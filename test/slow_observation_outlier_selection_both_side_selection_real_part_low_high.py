	...
	for i in range(tiles):
		for j in range(freqs):
			...
			for k in range(len(obs_list)):
				f = fits.open(data_directory + "hyperdrive_solutions_%s.fits" %(obs_list[k]))
...
if __name__ == "__main__":
	...
	step = 0.5 / iteration_number

	# Define data directory
	data_directory = "/Users/eormacstudio/Documents/GitHub/GRANDWin/data/raw/calibration_solutions/20250722_observation_data_8s_before_with_cotter_time_corrections_without_flags/uvfits/calibrated_fits/"
	observation_file = "/Users/eormacstudio/Documents/GitHub/GRANDWin/data/raw/observation_id/observation_id.csv"
	result_directory = "/Users/eormacstudio/Documents/GitHub/GRANDWin/test/results/slower/observation_data/"
